...
class Config:
    ...
    two_in_row_bonus: float = 0.5  # Bonus for forming a doublet.
    block_opponent_bonus: float = 0.6  # Bonus for blocking opponent doublet.
    block_miss_penalty: float = -1.0  # Penalty for not blocking a threat.
    miss_win_opportunity_penalty: float = -0.6  # Penalty for missing own win.
    ...
    checkpoint_path = Path("checkpoints/best_agent.pt")
